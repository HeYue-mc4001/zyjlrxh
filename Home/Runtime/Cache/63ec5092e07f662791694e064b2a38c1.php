...
<input type="submit" value="搜索"></div></form></div><div id="navigation"><div id="nav_box"><li id="list_1" onMouseOver="javascript:toggle_nav(1)" style="background:url(__PUBLIC__/images/nav_l.png);"><a href="__ROOT__/index.php">首页</a></li><?php if(is_array($categorylist)): $i = 0; $__LIST__ = $categorylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><li id="list_<?php echo ($i+1); ?>" onMouseOver="javascript:toggle_nav(<?php echo ($i+1); ?>)"><a href="__APP__/<?php echo ($cate["module"]); ?>"><?php echo ($cate["cname"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?><li id="list_9" onMouseOver="javascript:toggle_nav(9)" style="background:url(__PUBLIC__/images/nav_r.png);"><a href="__ROOT__/member.php">会员中心</a></li></div></div><div id="zzjs_nav1" class="headt" style="display:block">                欢迎来到职业经理人协会网站……
    </div><?php if(is_array($categorylist)): $j = 0; $__LIST__ = $categorylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($j % 2 );++$j;?><div id="zzjs_nav<?php echo ($j+1); ?>" class="headt" style="display:none"><?php if(is_array($cate['subcate'])): $i = 0; $__LIST__ = $cate['subcate'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><a href="__APP__/<?php echo ($cate["module"]); ?>/column?pcid=<?php echo ($sub["cid"]); ?>"><?php echo ($sub["cname"]); ?></a> |<?php endforeach; endif; else: echo "" ;endif; ?></div><?php endforeach; endif; else: echo "" ;endif; ?><div id="zzjs_nav9" class="headt" style="display:none"><a href="__ROOT__/member.php/index/contacts">人脉</a> | <a href="__ROOT__/member.php/index/group">圈子</a> | <a href="__ROOT__/member.php/index/mblog">微博</a> | <a href="__ROOT__/member.php/index/message">消息</a> | <a href="__ROOT__/member.php/index/webim">聊天室</a> | <a href="__ROOT__/member.php/index/setcenter">个人设置</a></div></div><div id="main" class="p_t5"><div id="m_l"><div class="list_"><div id="KinSlideshow" style="visibility:hidden; float:left;"><?php if(is_array($slidelist)): $i = 0; $__LIST__ = $slidelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sl): $mod = ($i % 2 );++$i;?><a href="<?php echo ($sl["link"]); ?>" target="_blank"><img src="__ROOT__/<?php echo ($sl["path"]); ?>" alt="<?php echo ($sl["title"]); ?>" width="1024" height="300" /></a><?php endforeach; endif; else: echo "" ;endif; ?></div></div><div class="list_ f_l m_t5"><div id="" class="nav_ bd bg"><div class="b_h"><span class="f_l">培训推荐</span></div><div class="b_m m_l5 f_l"><table width="100%" border="0"><?php if(is_array($train_n)): $i = 0; $__LIST__ = $train_n;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t_n): $mod = ($i % 2 );++$i;?><tr><td width="75%"><a href="__APP__/train/content?aid=<?php echo ($t_n["aid"]); ?>" title="<?php echo ($t_n["title"]); ?>" target="_blank"><li><?php echo (msubstr($t_n["title"],0,40)); echo ($t_n["is_new"]); ?></li></a></td><td width="25%" align="right"><span class="f_r"><?php echo (date("Y-m-d",$t_n["dateline"])); ?></span></td></tr><?php endforeach; endif; else: echo "" ;endif; ?></table></div></div><div id="" class="m_l5 bd bg nav_"><div class="b_h"><span class="f_l">培训经典</span></div><div class="b_m m_l5 f_l"><table width="100%" border="0"><?php if(is_array($train_hot)): $i = 0; $__LIST__ = $train_hot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t_h): $mod = ($i % 2 );++$i;?><tr><td width="75%"><a href="__APP__/train/content?aid=<?php echo ($t_h["aid"]); ?>" title="<?php echo ($t_h["title"]); ?>" target="_blank"><li><?php echo (msubstr($t_h["title"],0,40)); echo ($t_h["is_new"]); ?></li></a></td><td width="25%" align="right"><span class="f_r"><?php echo (date("Y-m-d",$t_h["dateline"])); ?></span></td></tr><?php endforeach; endif; else: echo "" ;endif; ?></table></div></div></div></div><div id="roll"><DIV class="rollphotos"><DIV class=FixTitle><font class="f_l m_l5">培训相关</font></DIV><DIV class=blk_29><DIV class=LeftBotton id=LeftArr></DIV><DIV class=Cont id=ISL_Cont_1><!-- 图片列表 begin --><?php if(is_array($trainimg)): $i = 0; $__LIST__ = $trainimg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><DIV class=box><A class=imgBorder href="__URL__/content?aid=<?php echo ($vo['aid']); ?>" target=_blank><IMG height=90 alt="<?php echo ($vo['title']); ?>" src="__ROOT__/<?php echo ($vo['pic']); ?>" width=120 
border=0></A><P><A href="__URL__/content?aid=<?php echo ($vo['aid']); ?>" 
target=_blank title="<?php echo ($vo['title']); ?>"><?php echo (msubstr($vo['title'],0,5)); ?></A></P></DIV><?php endforeach; endif; else: echo "" ;endif; ?><!-- 图片列表 end --></DIV><DIV class=RightBotton id=RightArr></DIV></DIV><SCRIPT language=javascript type=text/javascript><!--//--><![CDATA[//><!--
